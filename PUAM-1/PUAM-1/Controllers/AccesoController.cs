...
namespace PUAM_1.Controllers
{
    public class AccesoController : Controller
    {
        ...
        string cadena = "Data Source=DESKTOP-NJCRGQI;Integrated Security=True;Initial Catalog = PUAM;Connect Timeout=30;Encrypt=False;TrustServerCertificate=False;ApplicationIntent=ReadWrite;MultiSubnetFailover=False";
        ...
        public ActionResult RegistrarAdulto(Adulto adulto)
        {
            ...
            if (adulto.Nombres==null || adulto.Apellidos==null || adulto.Cedula == null || adulto.Edad==null || adulto.Celular==null || adulto.IdPrograma==null || adulto.Clave==null || adulto.ConfirmarClave==null)
            {
